#Generátor hesel pro konkrétní uživatele
import random
...
#uživatelé (zdenek;pepik;karel)
names = input("Zadej uživatelská jména oddělená středníkem (;) bez mezer:\nNapříklad: pepik;karel;vlasta\n")
